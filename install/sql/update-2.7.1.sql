-- Add plugin_resources_employers_id column if it doesn't exist (for upgrade from older versions)
-- This column is already part of the schema in fresh installations
-- ALTER TABLE `glpi_plugin_resources_departments`
--     ADD `plugin_resources_employers_id` INT(11) NULL DEFAULT '0' AFTER `entities_id`;

CREATE TABLE IF NOT EXISTS `glpi_plugin_resources_linkads`
(
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_resources_linkmetademands`
(
    `id`                                int unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_resources_adconfigs`
(
    `id`                         int unsigned NOT NULL auto_increment,
    `auth_id`                    int unsigned NOT NULL                     default '0',
